...
if(isset($_POST['signupSubmit'])){
    ...
    if(!empty($_POST['first_name']) && !empty($_POST['last_name']) && !empty($_POST['email']) && !empty($_POST['phone']) && !empty($_POST['password']) && !empty($_POST['confirm_password']) && !empty($_POST['dob'])&& !empty($_POST['age'])){
        ...
        if($_POST['password'] !== $_POST['confirm_password']){
            ...
            if($prevUser > 0){
                ...
                $userData = array(
                    ...
                    'phone' => $_POST['phone'],'dob' => $_POST['dob'],'age' => $_POST['age']
                );
